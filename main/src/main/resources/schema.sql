...
create table IF NOT EXISTS compilations_events(
    ...
    event_id BIGINT NOT NULL,
    CONSTRAINT fk_compilations_events_compilation FOREIGN KEY (compilation_id) REFERENCES compilations (id) ON update CASCADE on delete cascade,
    CONSTRAINT fk_compilations_events_event FOREIGN KEY (event_id) REFERENCES events (id) ON update CASCADE on delete cascade,
